...
interface SignerServiceAsync {
    ...
    fun getRejectionReason(signerId: String): CompletableFuture<SignerGetRejectionReasonResponse> =
    ...
    fun reset(signerId: String, params: SignerResetParams): CompletableFuture<Void?> =
    ...
    /** @see reset */
    fun reset(params: SignerResetParams): CompletableFuture<Void?> =
    ...
    interface WithRawResponse {
         ...
         * same as [SignerServiceAsync.getRejectionReason].
         */
        fun getRejectionReason(
            signerId: String
         ...
         * same as [SignerServiceAsync.reset].
         */
        fun reset(signerId: String, params: SignerResetParams): CompletableFuture<HttpResponse> =
            reset(signerId, params, RequestOptions.none())
        ...
        /** @see reset */
        fun reset(params: SignerResetParams): CompletableFuture<HttpResponse> =
            reset(params, RequestOptions.none())
