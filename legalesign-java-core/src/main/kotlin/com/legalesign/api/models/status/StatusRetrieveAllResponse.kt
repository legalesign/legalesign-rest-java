...
class StatusRetrieveAllResponse
private constructor(
    private val meta: JsonField<ListMeta>,
    private val objects: JsonField<List<StatusResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        objects: JsonField<List<StatusResponse>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun objects(): Optional<List<StatusResponse>> = objects.getOptional("objects")
    ...
    @JsonProperty("objects")
    @ExcludeMissing
    fun _objects(): JsonField<List<StatusResponse>> = objects
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StatusRetrieveAllResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [StatusRetrieveAllResponse]. */
    class Builder internal constructor() {

        private var meta: JsonField<ListMeta> = JsonMissing.of()
        private var objects: JsonField<MutableList<StatusResponse>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(statusRetrieveAllResponse: StatusRetrieveAllResponse) = apply {
            meta = statusRetrieveAllResponse.meta
            objects = statusRetrieveAllResponse.objects.map { it.toMutableList() }
            additionalProperties = statusRetrieveAllResponse.additionalProperties.toMutableMap()
        }
        ...
        fun objects(objects: List<StatusResponse>) = objects(JsonField.of(objects))

        /**
         * Sets [Builder.objects] to an arbitrary JSON value.
         *
         * You should usually call [Builder.objects] with a well-typed `List<StatusResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun objects(objects: JsonField<List<StatusResponse>>) = apply {
            this.objects = objects.map { it.toMutableList() }
        }

        /**
         * Adds a single [StatusResponse] to [objects].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addObject(object_: StatusResponse) = apply {
            objects =
        ...
        /**
         * Returns an immutable instance of [StatusRetrieveAllResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StatusRetrieveAllResponse =
    ...
    fun validate(): StatusRetrieveAllResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StatusRetrieveAllResponse &&
            meta == other.meta &&
    ...
    override fun toString() =
        "StatusRetrieveAllResponse{meta=$meta, objects=$objects, additionalProperties=$additionalProperties}"
}
