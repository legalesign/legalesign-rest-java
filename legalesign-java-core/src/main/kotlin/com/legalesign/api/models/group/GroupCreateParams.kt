...
private constructor(
     ...
     */
    fun xframeAllow(): Optional<Boolean> = body.xframeAllow()
     ...
     */
    fun _xframeAllow(): JsonField<Boolean> = body._xframeAllow()
    ...
    class Builder internal constructor() {
        ...
        /** Set to true if you want to embed your signing page. */
        fun xframeAllow(xframeAllow: Boolean) = apply { body.xframeAllow(xframeAllow) }
         ...
         * value.
         */
        fun xframeAllow(xframeAllow: JsonField<Boolean>) = apply { body.xframeAllow(xframeAllow) }
    ...
    private constructor(
        ...
        ) : this(name, xframeAllow, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("name", name), xframeAllow, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy { Objects.hash(name, xframeAllow, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, xframeAllow=$xframeAllow, additionalProperties=$additionalProperties}"
    }
