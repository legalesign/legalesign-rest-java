...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(firstName, lastName, additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Body{firstName=$firstName, lastName=$lastName, additionalProperties=$additionalProperties}"
    }
