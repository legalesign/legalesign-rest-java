...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(templateUpdateParams: TemplateUpdateParams) = apply {
            templateId = templateUpdateParams.templateId
            body = templateUpdateParams.body
    ...
    override fun toString() =
        "TemplateUpdateParams{templateId=$templateId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
