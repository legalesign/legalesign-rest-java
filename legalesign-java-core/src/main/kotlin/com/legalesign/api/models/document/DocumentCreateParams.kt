...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            ...
            /**
             * @throws LegalesignInvalidDataException if the JSON field has an unexpected type (e.g.
        ...
        class Role @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            fun known(): Known =
                when (this) {
                    ...
                    else -> throw LegalesignInvalidDataException("Unknown Role: $value")
                }
    ...
    class PdfPasswordType @JsonCreator private constructor(private val value: JsonField<Long>) :
        ...
        fun known(): Known =
            when (this) {
                _1 -> Known._1
                _2 -> Known._2
                else -> throw LegalesignInvalidDataException("Unknown PdfPasswordType: $value")
            }
