...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [StatusResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [StatusResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statusResponse: StatusResponse) = apply {
            archived = statusResponse.archived
            downloadFinal = statusResponse.downloadFinal
            resourceUri = statusResponse.resourceUri
            status = statusResponse.status
            tag = statusResponse.tag
            tag1 = statusResponse.tag1
            tag2 = statusResponse.tag2
            additionalProperties = statusResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [StatusResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StatusResponse =
            StatusResponse(
                archived,
                downloadFinal,
                resourceUri,
    ...
    fun validate(): StatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "StatusResponse{archived=$archived, downloadFinal=$downloadFinal, resourceUri=$resourceUri, status=$status, tag=$tag, tag1=$tag1, tag2=$tag2, additionalProperties=$additionalProperties}"
}
