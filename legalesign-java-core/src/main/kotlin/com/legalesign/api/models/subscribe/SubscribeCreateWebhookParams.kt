...
/** Create webhook */
class SubscribeCreateWebhookParams
private constructor(
     ...
     */
    fun _notify(): JsonField<String> = body._notify()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubscribeCreateWebhookParams].
         *
    ...
    /** A builder for [SubscribeCreateWebhookParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subscribeCreateWebhookParams: SubscribeCreateWebhookParams) = apply {
            body = subscribeCreateWebhookParams.body.toBuilder()
            additionalHeaders = subscribeCreateWebhookParams.additionalHeaders.toBuilder()
            additionalQueryParams = subscribeCreateWebhookParams.additionalQueryParams.toBuilder()
        }
         ...
         * The type of callback to receive, value must be all, signed, sent, rejected or realtime
         */
        fun notify(notify: String) = apply { body.notify(notify) }

        /**
         * Sets [Builder.notify] to an arbitrary JSON value.
         *
         * You should usually call [Builder.notify] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun notify(notify: JsonField<String>) = apply { body.notify(notify) }
        ...
        /**
         * Returns an immutable instance of [SubscribeCreateWebhookParams].
         *
         ...
         */
        fun build(): SubscribeCreateWebhookParams =
            SubscribeCreateWebhookParams(
                body.build(),
    ...
    class Body
    private constructor(
        private val notify: JsonField<String>,
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("notify") @ExcludeMissing notify: JsonField<String> = JsonMissing.of(),
        ...
        ) : this(notify, url, eventFilter, group, mutableMapOf())
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun notify(): String = notify.getRequired("notify")
         ...
         * Unlike [notify], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("notify") @ExcludeMissing fun _notify(): JsonField<String> = notify
        ...
        class Builder internal constructor() {
            ...
            private var notify: JsonField<String>? = null
             ...
             * realtime
             */
            fun notify(notify: String) = notify(JsonField.of(notify))

            /**
             * Sets [Builder.notify] to an arbitrary JSON value.
             *
             * You should usually call [Builder.notify] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun notify(notify: JsonField<String>) = apply { this.notify = notify }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(notify, url, eventFilter, group, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{notify=$notify, url=$url, eventFilter=$eventFilter, group=$group, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscribeCreateWebhookParams &&
            body == other.body &&
    ...
    override fun toString() =
        "SubscribeCreateWebhookParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
