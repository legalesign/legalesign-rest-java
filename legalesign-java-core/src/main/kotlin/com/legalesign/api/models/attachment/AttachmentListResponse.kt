...
private constructor(
    ...
    private val objects: JsonField<List<AttachmentResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        objects: JsonField<List<AttachmentResponse>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun objects(): Optional<List<AttachmentResponse>> = objects.getOptional("objects")
    ...
    @JsonProperty("objects")
    @ExcludeMissing
    fun _objects(): JsonField<List<AttachmentResponse>> = objects
    ...
    class Builder internal constructor() {
        ...
        private var objects: JsonField<MutableList<AttachmentResponse>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(attachmentListResponse: AttachmentListResponse) = apply {
            meta = attachmentListResponse.meta
            objects = attachmentListResponse.objects.map { it.toMutableList() }
        ...
        fun objects(objects: List<AttachmentResponse>) = objects(JsonField.of(objects))

        /**
         * Sets [Builder.objects] to an arbitrary JSON value.
         *
         * You should usually call [Builder.objects] with a well-typed `List<AttachmentResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun objects(objects: JsonField<List<AttachmentResponse>>) = apply {
            this.objects = objects.map { it.toMutableList() }
        }

        /**
         * Adds a single [AttachmentResponse] to [objects].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addObject(object_: AttachmentResponse) = apply {
            objects =
    ...
    override fun toString() =
        "AttachmentListResponse{meta=$meta, objects=$objects, additionalProperties=$additionalProperties}"
}
