...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.legalesign.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.legalesign.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.legalesign.api.** {
    <init>(...);
