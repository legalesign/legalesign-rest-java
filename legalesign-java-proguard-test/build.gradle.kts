...
dependencies {
    testImplementation(project(":legalesign-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../legalesign-java-core/src/main/resources/META-INF/proguard/legalesign-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.legalesign.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../legalesign-java-core/src/main/resources/META-INF/proguard/legalesign-java-core.pro",
