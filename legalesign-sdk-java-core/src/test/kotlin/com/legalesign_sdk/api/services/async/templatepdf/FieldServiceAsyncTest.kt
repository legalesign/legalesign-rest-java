...
package com.legalesign_sdk.api.services.async.templatepdf
...
internal class FieldServiceAsyncTest {
    ...
    fun create() {
        val client =
            LegalesignSdkOkHttpClientAsync.builder()
                ...
                .apiKey("My API Key")
                .build()
        val fieldServiceAsync = client.templatepdf().fields()

        val future =
            fieldServiceAsync.create(
    ...
    fun list() {
        ...
        val fieldsFuture = fieldServiceAsync.list("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")

        val fields = fieldsFuture.get()
        fields.validate()
    }
}
