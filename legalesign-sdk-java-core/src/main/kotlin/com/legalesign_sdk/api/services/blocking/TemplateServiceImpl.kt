...
class TemplateServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun create(params: TemplateCreateParams, requestOptions: RequestOptions) {
        // post /template/
    ...
    override fun update(params: TemplateUpdateParams, requestOptions: RequestOptions) {
