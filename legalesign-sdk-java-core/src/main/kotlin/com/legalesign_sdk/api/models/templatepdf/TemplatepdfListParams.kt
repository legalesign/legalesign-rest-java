...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TemplatepdfListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TemplatepdfListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TemplatepdfListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(templatepdfListParams: TemplatepdfListParams) = apply {
            archive = templatepdfListParams.archive
            group = templatepdfListParams.group
            limit = templatepdfListParams.limit
            offset = templatepdfListParams.offset
            additionalHeaders = templatepdfListParams.additionalHeaders.toBuilder()
            additionalQueryParams = templatepdfListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TemplatepdfListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TemplatepdfListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TemplatepdfListParams &&
    ...
    override fun toString() =
        "TemplatepdfListParams{archive=$archive, group=$group, limit=$limit, offset=$offset, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
