...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(documentRetrieveParams: DocumentRetrieveParams) = apply {
            docId = documentRetrieveParams.docId
        ...
        fun build(): DocumentRetrieveParams =
            DocumentRetrieveParams(docId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "DocumentRetrieveParams{docId=$docId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
