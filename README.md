...
[![Maven Central](https://img.shields.io/maven-central/v/com.legalesign.api/legalesign-java)](https://central.sonatype.com/artifact/com.legalesign.api/legalesign-java/0.0.1)
[![javadoc](https://javadoc.io/badge2/com.legalesign.api/legalesign-java/0.0.1/javadoc.svg)](https://javadoc.io/doc/com.legalesign.api/legalesign-java/0.0.1)
...
The REST API documentation can be found on [legalesign.com](https://legalesign.com/contact/). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.legalesign.api/legalesign-java/0.0.1).
...
```kotlin
implementation("com.legalesign.api:legalesign-java:0.0.1")
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/legalesign-java/issues) with questions, bugs, or suggestions.
