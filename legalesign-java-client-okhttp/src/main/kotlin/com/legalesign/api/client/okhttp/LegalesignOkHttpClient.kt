...
import com.legalesign.api.client.LegalesignClientImpl
...
/**
 * A class that allows building an instance of [LegalesignClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class LegalesignOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [LegalesignClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): LegalesignClient = builder().fromEnv().build()
    }

    /** A builder for [LegalesignOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [LegalesignClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LegalesignClient =
            LegalesignClientImpl(
                clientOptions
                    .httpClient(
