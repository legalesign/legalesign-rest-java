...
package com.legalesign.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.legalesign.api.client.LegalesignClientAsync
import com.legalesign.api.client.LegalesignClientAsyncImpl
import com.legalesign.api.core.ClientOptions
import com.legalesign.api.core.Sleeper
import com.legalesign.api.core.Timeout
import com.legalesign.api.core.http.Headers
import com.legalesign.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [LegalesignClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class LegalesignOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [LegalesignClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): LegalesignClientAsync = builder().fromEnv().build()
    }

    /** A builder for [LegalesignOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.legalesign.api.core.jsonMapper]. The default is usually sufficient and
         ...
         *
         * Defaults to the production environment: `https://lon-dev.legalesign.com/api/v1`.
         */
        ...
        /**
         * Returns an immutable instance of [LegalesignClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LegalesignClientAsync =
            LegalesignClientAsyncImpl(
                clientOptions
                    .httpClient(
