    ...
    publications {
        register<MavenPublication>("maven") {
            ...
            pom {
                ...
                developers {
                    developer {
                        name.set("Legalesign SDK")
                        email.set("support@legalesign.com")
                    }
                }

                scm {
                    connection.set("scm:git:git://github.com/stainless-sdks/legalesign-sdk-java.git")
                    developerConnection.set("scm:git:git://github.com/stainless-sdks/legalesign-sdk-java.git")
                    url.set("https://github.com/stainless-sdks/legalesign-sdk-java")
                }
