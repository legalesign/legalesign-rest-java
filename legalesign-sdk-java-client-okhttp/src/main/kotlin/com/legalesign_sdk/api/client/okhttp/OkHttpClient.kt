...
import com.legalesign_sdk.api.core.http.HttpRequestBody
import com.legalesign_sdk.api.core.http.HttpResponse
import com.legalesign_sdk.api.errors.LegalesignSdkIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw LegalesignSdkIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
            ...
            .enqueue(
                object : Callback {
                    ...
                    override fun onFailure(call: Call, e: IOException) {
                        future.completeExceptionally(LegalesignSdkIoException("Request failed", e))
                    }
                }
            )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("LEGALESIGN_SDK_LOG")?.lowercase()) {
