...
import com.legalesign_sdk.api.client.LegalesignSdkClientImpl
...
/**
 * A class that allows building an instance of [LegalesignSdkClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class LegalesignSdkOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [LegalesignSdkClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): LegalesignSdkClient = builder().fromEnv().build()
    }

    /** A builder for [LegalesignSdkOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [LegalesignSdkClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LegalesignSdkClient =
            LegalesignSdkClientImpl(
                clientOptions
                    .httpClient(
