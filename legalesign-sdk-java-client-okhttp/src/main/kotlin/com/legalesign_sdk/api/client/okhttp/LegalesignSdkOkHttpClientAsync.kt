...
package com.legalesign_sdk.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.legalesign_sdk.api.client.LegalesignSdkClientAsync
import com.legalesign_sdk.api.client.LegalesignSdkClientAsyncImpl
import com.legalesign_sdk.api.core.ClientOptions
import com.legalesign_sdk.api.core.Sleeper
import com.legalesign_sdk.api.core.Timeout
import com.legalesign_sdk.api.core.http.Headers
import com.legalesign_sdk.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [LegalesignSdkClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class LegalesignSdkOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [LegalesignSdkClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): LegalesignSdkClientAsync = builder().fromEnv().build()
    }

    /** A builder for [LegalesignSdkOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.legalesign_sdk.api.core.jsonMapper]. The default is usually sufficient
         ...
         *
         * Defaults to the production environment: `https://eu-api.legalesign.com/api/v1`.
         */
        ...
        /**
         * Returns an immutable instance of [LegalesignSdkClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LegalesignSdkClientAsync =
            LegalesignSdkClientAsyncImpl(
                clientOptions
                    .httpClient(
