...
dependencies {
    testImplementation(project(":legalesign-sdk-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../legalesign-sdk-java-core/src/main/resources/META-INF/proguard/legalesign-sdk-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.legalesign_sdk.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../legalesign-sdk-java-core/src/main/resources/META-INF/proguard/legalesign-sdk-java-core.pro",
